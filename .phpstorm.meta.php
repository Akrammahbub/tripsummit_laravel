...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.disks.laravel_export.driver' => 'string',
            'filesystems.disks.laravel_export.root' => 'string',
            'filesystems.links.D:\Project\tripsummit_laravel\public\storage' => 'string',
            ...
            'export.crawl' => 'boolean',
            'export.paths' => 'array',
            'export.include_files.public' => 'string',
            'export.exclude_file_patterns' => 'string',
            'export.clean_before_export' => 'boolean',
            'export.disk' => 'NULL',
            'export.before' => 'array',
            'export.after' => 'array',
...
'auth.guards.admin.driver','auth.guards.admin.provider','auth.guards.user.driver','auth.guards.user.provider','auth.providers.users.driver',
...
'filesystems.disks.s3.url','filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.laravel_export.driver',
'filesystems.disks.laravel_export.root','filesystems.links.D:\\Project\\tripsummit_laravel\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'view.paths','view.compiled','export.crawl','export.paths','export.include_files.public',
'export.exclude_file_patterns','export.clean_before_export','export.disk','export.before','export.after',
...
'web','api',);
        registerArgumentsSet('routes', 'home','about','destinations','destination',
'packages','package','team-member','team-members','faq',
'blog','contact','registration','registration_submit','registration_verify',
'login','forget_password','admin_dashboard','admin_profile','admin_profile_submit',
'admin_login','admin_login_submit','admin_logout','admin_forget_password','admin_forget_password_submit',
'admin_reset_password','admin_reset_password_submit','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.forget-password','admin.layout.master','admin.layout.nav','admin.layout.sidebar',
'admin.login','admin.profile','admin.reset-password','email','front.about',
'front.blog','front.contact','front.destination','front.destinations','front.faq',
'front.forget_password','front.home','front.layout.master','front.layout.nav','front.login',
'front.package','front.packages','front.registration','front.team_member','front.team_members',
